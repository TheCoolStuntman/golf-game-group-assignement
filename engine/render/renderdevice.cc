...
void RenderDevice::Init()
{
    ...
    // Shaders
    {
        ...
        auto fs = Render::ShaderResource::LoadShader(Render::ShaderResource::ShaderType::FRAGMENTSHADER, "shd/fs_static.fs");
        staticGeometryProgram = Render::ShaderResource::CompileShaderProgram({ vs, fs });
    }
    {
        auto vs = Render::ShaderResource::LoadShader(Render::ShaderResource::ShaderType::VERTEXSHADER, "shd/vs_static_shadow.vs");
        auto fs = Render::ShaderResource::LoadShader(Render::ShaderResource::ShaderType::FRAGMENTSHADER, "shd/fs_static_shadow.fs");
        staticShadowProgram = Render::ShaderResource::CompileShaderProgram({ vs, fs });
    }
    {
        auto vs = Render::ShaderResource::LoadShader(Render::ShaderResource::ShaderType::VERTEXSHADER, "shd/vs_skybox.vs");
        auto fs = Render::ShaderResource::LoadShader(Render::ShaderResource::ShaderType::FRAGMENTSHADER, "shd/fs_skybox.fs");
